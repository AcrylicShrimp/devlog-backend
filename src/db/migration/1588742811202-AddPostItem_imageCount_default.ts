...
export class AddPostItemImageCountDefault1588742811202 implements MigrationInterface {
    name = 'AddPostItemImageCountDefault1588742811202'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `post_item` CHANGE `imageCount` `imageCount` int NOT NULL DEFAULT 0", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `post_item` CHANGE `imageCount` `imageCount` int NOT NULL", undefined);

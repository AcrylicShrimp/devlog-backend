...
export class AddUUID1588118648771 implements MigrationInterface {
    name = 'AddUUID1588118648771'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `post_item` ADD `uuid` varchar(64) NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `post_item` ADD UNIQUE INDEX `IDX_4617c669790536b49d2f94b9e5` (`uuid`)", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `admin_session` ADD CONSTRAINT `FK_b41305caf8ef2f3847957746a2f` FOREIGN KEY (`userId`) REFERENCES `admin`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `post_item` DROP INDEX `IDX_4617c669790536b49d2f94b9e5`", undefined);
        await queryRunner.query("ALTER TABLE `post_item` DROP COLUMN `uuid`", undefined);
    }

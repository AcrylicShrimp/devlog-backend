...
export class ModifyPostItemImage1588155348887 implements MigrationInterface {
    name = 'ModifyPostItemImage1588155348887'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `post_item_image` CHANGE `width` `width` int NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `post_item_image` CHANGE `height` `height` int NOT NULL", undefined);
